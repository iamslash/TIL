...
It's about Distributed Transactions. There are several methods for Distributed Transactions including TCC (Try Confirm/Cancel), Event Driven.
...
# TCC (Trey-Confirm/Cancel), 2 Phase commit
