- [Materials](#materials)
- [REST API 및 프로젝트 소개](#rest-api-및-프로젝트-소개)
  - [REST API](#rest-api)
...
- [HATEOAS 와 Self-Descriptive](#hateoas-와-self-descriptive)
...
- [이벤트 조회 및 수정 REST API 개발](#이벤트-조회-및-수정-rest-api-개발)
  - [이벤트 목록 조회 API 구현](#이벤트-목록-조회-api-구현)
  - [이벤트 조회 API 구현](#이벤트-조회-api-구현)
  - [이벤트 수정 API 구현](#이벤트-수정-api-구현)
  - [테스트 코드 리펙토링](#테스트-코드-리펙토링)
- [REST API 와 보안 적용](#rest-api-와-보안-적용)
